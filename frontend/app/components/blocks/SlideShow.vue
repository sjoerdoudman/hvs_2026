<template>
    <section ref="containerRef" class="relative bg-theme-offblack pt-double-space pb-27.5 w-full overflow-x-hidden">
        <div class="relative container--lg">
            <button ref="navPrevRef" class="swiper-button-prev !md:flex custom-prev !left-triple-space bg-lime hover:scale-105 focus:scale-105 duration-100" aria-label="Previous slide">
            ...
            <button ref="navNextRef" class="swiper-button-next !md:flex custom-next !right-triple-space bg-lime hover:scale-105 focus:scale-105 duration-100" aria-label="Next slide">
